...
The following is a set of guidelines for contributing to the Lua2Py repo, which is hosted in the given [Github Link](https://github.com/Aoishi28/CSC591_Group5_Lua2Py_4). These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/Aoishi28/CSC591_Group5_Lua2Py_4/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/Aoishi28/CSC591_Group5_Lua2Py_4/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
